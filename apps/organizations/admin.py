...
class OrganizationAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'member_count', 'team_count', 'created_by', 'created_at'
    ]
    list_filter = [
    ...
    fieldsets = (
        ...
        ('Subscription', {
            'fields': ('subscription_plan', 'subscription_status', 'max_members', 'max_documents', 'max_storage_gb')
        }),
        ('Settings', {
            'fields': ('settings',),
            'classes': ('collapse',)
        ...
        ('Metadata', {
            'fields': ('id', 'created_by', 'created_at', 'updated_at', 'member_count', 'team_count'),
            'classes': ('collapse',)
        }),
    )
...
class TeamAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'name', 'organization', 'slug', 'member_count', 
        'is_default', 'is_archived', 'created_by', 'created_at'
    ]
    list_filter = [
        'organization', 'is_default', 'is_archived', 'created_at'
    ]
    ...
    fieldsets = (
        ...
        ('Metadata', {
            'fields': ('id', 'created_by', 'created_at', 'updated_at', 'member_count'),
            'classes': ('collapse',)
        }),
    )
...
class OrganizationMembershipAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'joined_at', 'last_accessed', 'invited_by'
    ]
    list_filter = [
        'role', 'status', 'organization', 'joined_at'
    ]
    search_fields = [
    ...
    fieldsets = (
        ...
        ('Metadata', {
            'fields': ('id', 'created_at', 'last_accessed'),
            'classes': ('collapse',)
        }),
    )
    ...
    def get_queryset(self, request):
        ...
        return super().get_queryset(request).select_related('user', 'organization', 'invited_by')
...
class TeamMembershipAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user', 'team', 'role', 'status', 
        'joined_at', 'invited_by'
    ]
    list_filter = [
        'role', 'status', 'team__organization', 'team', 'joined_at'
    ]
    search_fields = [
        'user__username', 'user__email', 'user__first_name', 'user__last_name',
        'team__name', 'team__organization__name'
    ]
    ...
    def get_queryset(self, request):
        ...
        return super().get_queryset(request).select_related(
            'user', 'team', 'team__organization', 'invited_by'
        )