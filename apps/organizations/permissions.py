...
class IsOrganizationMember(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        return OrganizationMembership.objects.filter(
            organization=organization, user=request.user, status="active"
        ).exists()
    ...
    def has_object_permission(self, request, view, obj):
        ...
        try:
            org_membership = OrganizationMembership.objects.get(
                organization=team.organization, user=request.user, status="active"
            )
...
class DynamicOrganizationPermission(
    OrganizationPermissionMixin, permissions.BasePermission
):
    """
    ...
    def __init__(
        self, required_org_roles=None, required_team_roles=None, allow_self=False
    ):
        """
