...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = [
            'id', 'name', 'slug', 'domain', 'description', 'logo_url',
            'subscription_plan', 'subscription_status', 'max_members', 
            'max_documents', 'max_storage_gb', 'settings', 'member_count',
            'team_count', 'can_add_member', 'created_by', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'member_count', 'team_count', 'can_add_member', 
...
class TeamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Team
        fields = [
            'id', 'organization', 'name', 'slug', 'description', 'color',
            'settings', 'is_default', 'is_archived', 'member_count',
            'user_role', 'created_by', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'organization', 'member_count', 'user_role',
            'created_by', 'created_at', 'updated_at'
        ]
    ...
    def validate_slug(self, value):
        ...
        if query.exists():
            raise serializers.ValidationError("Team with this slug already exists in the organization.")
        return value
...
class OrganizationMembershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'invited_by', 'invited_at', 'joined_at', 'last_accessed', 'created_at'
        ]
        read_only_fields = [
            'id', 'organization', 'user', 'invited_by', 'invited_at',
            'joined_at', 'last_accessed', 'created_at'
        ]
...
class OrganizationInviteSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if not organization.can_add_member():
            raise serializers.ValidationError("Organization has reached its member limit.")
...
class TeamMembershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'team', 'user', 'role', 'status', 'organization_role',
            'invited_by', 'joined_at', 'created_at'
        ]
        read_only_fields = [
            'id', 'team', 'user', 'invited_by', 'joined_at', 'created_at'
        ]
...
class TeamInviteSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if not OrganizationMembership.objects.filter(
            ...
            raise serializers.ValidationError("User must be an organization member first.")
