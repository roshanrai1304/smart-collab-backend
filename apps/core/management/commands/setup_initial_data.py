...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('🚀 Setting up initial data for Smart Collab...'))
        ...
        try:
            with transaction.atomic():
                ...
                if options['full']:
                    ...
                    self.stdout.write(self.style.SUCCESS('✅ Standard setup completed!'))
            ...
            if User.objects.filter(username=username).exists():
                ...
                UserProfile.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'push_notifications': True,
                        'preferences': {
                            'dashboard_layout': 'list' if user_data['theme'] == 'dark' else 'grid',
                            'auto_save': True,
                            'collaboration_sounds': True
                        }
                    }
    ...
    def display_summary(self, options):
        ...
        self.stdout.write('\n🔐 LOGIN CREDENTIALS:')
        self.stdout.write(f'   Superuser: {options["superuser_username"]} / {options["superuser_password"]}')
        ...
        self.stdout.write('   - API Docs: http://127.0.0.1:8000/api/v1/schema/swagger-ui/')
